...
public class EstadisticasVentaDTO {
    ...
    public VentaConImporteDTO getVentaMayor() { return ventaMayor; }
    public void setVentaMayor(VentaConImporteDTO ventaMayor) { this.ventaMayor = ventaMayor; }
    public VentaConImporteDTO getVentaMenor() { return ventaMenor; }
    public void setVentaMenor(VentaConImporteDTO ventaMenor) { this.ventaMenor = ventaMenor; }
